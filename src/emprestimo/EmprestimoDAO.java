...
public class EmprestimoDAO {
    ...
    public static void adicionarEmprestimo(Emprestimo emprestimo) {
        ...
        try (Session session = Conexao.getDatabaseSessionFactory().openSession()) {
            ...
            transaction.commit();
            System.out.println("Emprestimo.Emprestimo adicionado com sucesso.");
        } catch (Exception e) {
            if (transaction != null) {
    ...
    public static Emprestimo getEmprestimoPorID(int id) {
        try (Session session = Conexao.getDatabaseSessionFactory().openSession()) {
            ...
            if (emprestimo == null) {
                System.out.println("Emprestimo.Emprestimo com ID " + id + " não encontrado.");
            }
            return emprestimo;
        } catch (Exception e) {
    ...
    public static void atualizarEmprestimo(Emprestimo emprestimo) {
        ...
        try (Session session = Conexao.getDatabaseSessionFactory().openSession()) {
            ...
            session.persist(emprestimo);
            transaction.commit();
            System.out.println("Emprestimo.Emprestimo atualizado com sucesso.");
        } catch (Exception e) {
            if (transaction != null) {
                transaction.rollback();
            }
    ...
    public static void removerEmprestimo(Emprestimo emprestimo) {
        ...
        try (Session session = Conexao.getDatabaseSessionFactory().openSession()) {
            ...
            transaction.commit();
            System.out.println("Emprestimo.Emprestimo removido com sucesso.");
        } catch (Exception e) {
            if (transaction != null) {
                transaction.rollback();
            }
    ...
    public static void devolverEmprestimo(Emprestimo emprestimo, Livro livro) {
        ...
        try (Session session = Conexao.getDatabaseSessionFactory().openSession()) {
            ...
            System.out.println("Emprestimo.Emprestimo devolvido com sucesso.");
            transaction.commit();
